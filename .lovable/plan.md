...
- `whatsapp_config`: um campo de ativo/desativado por mensagem restante. Os campos removidos da tela continuam na tabela (não são apagados), apenas deixam de ser usados.
